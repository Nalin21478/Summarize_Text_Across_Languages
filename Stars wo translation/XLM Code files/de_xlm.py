...
max_length = 512  
train_dataset = CustomDataset(de_train['text'], de_train['stars'], tokenizer, max_length)
val_dataset = CustomDataset(de_val['text'], de_val['stars'], tokenizer, max_length)
test_dataset = CustomDataset(de_test['text'], de_test['stars'], tokenizer, max_length)
...
# %%
# save the model
model.save_pretrained("de_xlm_model")
