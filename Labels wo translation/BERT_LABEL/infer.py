...
# Change language and base model to get infer on relevant test set
LANG = 'fr'
LANGUAGE = "french"
...
model_id = "greasyFinger/"+LANGUAGE 
...
def get_data(split, k50 = False):
    ...
    fr_data = data.filter(lambda example: example['language'] == LANG)
    if k50:
...
hugging_id = "greasyFinger/english"
